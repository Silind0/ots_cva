...
############## Description ###################
# 1 раз в 1 секунду сохраняет черно-белый скриншот в папку images/gray_keys/
...
IMAGES_PATH = "data/images/gray_keys/"
...
def capture(folder):
    ...
    cv2.imwrite(imgname, gray)  # Необходимо отключить при замере производительности
